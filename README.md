...
### AVL Tree
An AVL tree (Georgy Adelson-Velsky and Landis' tree, named after tme they differ by more than one, rebalancing is done to restore this property.
